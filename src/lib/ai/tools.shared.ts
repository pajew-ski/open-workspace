...
/**
 * Builders that turn the workspace's FOREIGN tool sources — user
...
/**
 * Workspace-Fähigkeiten (Finder, Aufgaben, Dokumente, …) stehen NICHT
 * mehr hier: Sie sind Aktionen (ACTIONS_SPEC, `src/lib/actions/`), und
 * beide Tool-Loops leiten ihre Tool-Definitionen aus der Registry ab
 * (`actions/tools.ts` auf dem Server, `actions/browser.ts` im Browser).
 * Was bleibt, ist, was keine Aktion ist: API-Tools, MCP-Client-Tools und
 * `use_skill`.
 */
